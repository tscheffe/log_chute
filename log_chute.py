...
class LineCount(object):
    ...
    def print_result(self):
        print("Number of lines parsed: {}".format(self.lines))
...
class LogDuration(object):
    ...
    def print_result(self):
        ...
        print("Duration of log file: {}".format(duration))
...
class MostRequestedPage(object):
    ...
    def print_result(self):
        print("Most requested page: {}".format(self.most_requested_page))
...
class MostFrequentVisitor(object):
    ...
    def print_result(self):
        print("Most frequent visitor: {}".format(self.most_frequent_visitor))
...
class MinPageLoadTime(object):
    ...
    def print_result(self):
        print("Min page load time: {}".format(self.min_page_load_time))
...
class AveragePageLoadTime(object):
    ...
    def print_result(self):
        ...
        print("Average page load time: {}".format(average_load_time))
...
class MaxPageLoadTime(object):
    ...
    def print_result(self):
        print("Max page load time: {}".format(self.max_page_load_time))
...
class NumberOfErrors(object):
    ...
    def print_result(self):
        print("Number of errors: {}".format(self.total_errors))
...
class TotalDataTransfered(object):
    ...
    def print_result(self):
        print("Total data transferred: {}".format(self.total_data))
